	...
	<div class="wrapper">
		<nav id="sidebar" class="sidebar js-sidebar">
			<div class="sidebar-content js-simplebar">
				<a class="sidebar-brand" href="table.php">
          <span class="align-middle">Admin</span>
              ...
              <i class="align-middle" data-feather="user-plus"></i> <span class="align-middle">Sign Up</span>
					...
					<li class="sidebar-item active">
						<a class="sidebar-link" href="signin.php">
		...
		<div class="main">
          ...
          <i class="hamburger align-self-center"></i>
			  ...
			  <?php
include('./connect.php');
$sql = "SELECT * FROM `usersdata` LIMIT 1"; // LIMIT 1 will fetch only one row
$connect = mysqli_query($con, $sql);

if (mysqli_num_rows($connect) > 0) {
    $data = mysqli_fetch_assoc($connect); // Fetch the first row

    ?>
    <a class="nav-link dropdown-toggle d-none d-sm-inline-block" href="#" data-bs-toggle="dropdown">
        <img src="<?php echo $data['image'] ?>" alt="" width="40px" height="40px" style="border-radius:10px;">
...
?>
			...
			<main class="content">
				<div class="container-fluid p-0">
					...
					<div class="row">
						<div class="col-12 col-lg-8 col-xxl-9 d-flex"  style="width:1300px;" >
							<div class="card flex-fill">
								<div class="card-header">

									<h5 class="card-title mb-0">Users</h5>
								</div>
								<table class="table table-hover " style="width:993px;">
								<?php
        include('./connect.php');
    ...
    <!-- <a href="logout.php" class="btn btn-danger" id="btnlogout" style=" width:100px; ">logout</a> -->
